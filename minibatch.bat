...
:aftertutorialtext
cls
if %firstrunvar1% equ 1 (
    set /a firstrunchoose=%firstrunchoose%+1
)
cls
if %firstrunvar2% equ 1 (
    set /a firstrunchoose=%firstrunchoose%+1
)
cls
if %firstrunvar2% equ 1 (
...
cls
if %firstrunchoose% equ 3 (
    echo You finished the tutorial!
    echo Now go on with your game!
    goto main
)
echo 1. Go mine
echo 2. Go fight
...
timeout /t 1 /nobreak >nul
cls
echo You chopped %mineloot% Iron ores with your %picktype%.
timeout /t 2 /nobreak >nul
echo Press any key to continue
pause >nul
set /a firstrunvar3=1
goto aftertutorialtext
...
:: main
:main
echo WARNING: The non-tutorial walktrough is not avabile yet in this version, a more complete version will be published as soon as possible
echo You will still be sent to tutorial actions
echo 1. Go mine
echo 2. Go fight
echo 3. Go chop
choice /c 123 /m "What do you want to do?"
